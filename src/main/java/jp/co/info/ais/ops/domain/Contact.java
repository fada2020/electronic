...
public class Contact {
	...
	public String toString() {
		return "Contact [result=" + result + ", rownum=" + rownum + ", contactcd=" + contactcd + ", contactname="
				+ contactname + ", contactphoneno=" + contactphoneno + ", contactmailaddress=" + contactmailaddress
